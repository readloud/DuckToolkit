...
// *                                        - PS2303.h -
// *
// * Header file for the Phison PS2303 USB 3.0 - NAND bridge.
// *
// **************************************************************************************************
...
//transfer direction NAND->RAM
#define bmNandDmaRead	0
//transfer direction RAM->NAND
...
// ------------------------------------------------------------------------------------------------
//                                        Xdata F400-F4FF NAND0 Registers
// ------------------------------------------------------------------------------------------------
__xdata __at 0xF400 volatile NANDREGS NFC0;

// ------------------------------------------------------------------------------------------------
//                                        Xdata F500-F5FF NAND1 Registers
// ------------------------------------------------------------------------------------------------
__xdata __at 0xF500 volatile NANDREGS NFC1;

// ------------------------------------------------------------------------------------------------
//                                        Xdata F600-F6FF NAND Common Registers
// ------------------------------------------------------------------------------------------------
...
// ------------------------------------------------------------------------------------------------
//                                        Xdata F700-F7FF NAND Shadow Registers
// ------------------------------------------------------------------------------------------------
// ??? NAND0 is mirrored here
...
// ------------------------------------------------------------------------------------------------
//                                        Xdata F900-F9FF DMA Registers
// ------------------------------------------------------------------------------------------------
// lower 3 bits of SRC/DST/SIZE are ignored (8-byte alignment forced)
...
// DMA fill value
// 8-bit fill uses DMAFILL0
// 16-bit fill uses DMAFILL1, DMAFILL0 (result will look like 01 00 01 00 01 00...) 
// 32-bit fill uses DMAFILL3, DMAFILL2, DMAFILL1, DMAFILL0 (result will look like 03 02 01 00 03 02 01 00...)
...
// DMA command
// there are more Cmd values - 1, 3 unexplored
// bit 5 has some meaning too, unexplored
